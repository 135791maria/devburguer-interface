...
export function CompletePayment() {
  ...
  <div className="container">
    <div id="payment-status">
      ...
      {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details" rel="noopener noreferrer" 
      target="_blank">Ver detalhe.
